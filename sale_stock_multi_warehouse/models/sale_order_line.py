    ...
    def _compute_warehouse_stock_info(self):
        ...
        for (company_id, scheduled_date), lines in grouped_lines.items():
            ...
            for warehouse in warehouses:
                # Odoo 18/19 scope product quantities via the context key
